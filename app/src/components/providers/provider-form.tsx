  ...
  return (
    <form action={formAction} className="space-y-4 max-w-lg">
      ...
      <div className="space-y-1.5">
        ...
        <Input id="specialty" name="specialty" placeholder="Ex: Elétrica, Hidráulica, TI..." defaultValue={provider?.specialty ?? ""} />
      </div>
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-1.5">
          <Label htmlFor="phone">Telefone</Label>
          <Input id="phone" name="phone" placeholder="(00) 00000-0000" defaultValue={provider?.phone ?? ""} />
        </div>
        <div className="space-y-1.5">
